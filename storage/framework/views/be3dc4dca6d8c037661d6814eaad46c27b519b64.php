<form method="POST" id="id-form_messages" name="form_messages" action="/add">
    ...
    <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
        ...
        <input class="form-control" placeholder="Имя" name="name" type="text" id="name" value="<?php echo e(Auth::user()->name); ?>">
    ...
    <div class="form-group <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
        ...
        <input class="form-control" placeholder="E-mail" name="email" type="email" id="email" value="<?php echo e(Auth::user()->email); ?>">
